        ...
        <div class="bg-primary" id="sidebar-container">
            ...
            <div class="menu">
                ...
                <a href="{{ route('libros-index') }}" class="d-block text-light p-3">
                    ...
                    Libros</a>
                <a href="{{ route('cuadernos-index') }}" class="d-block text-light p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                    ...
                    Cuadernos </a>
                <a href="{{ route('proveedores-index') }}" class="d-block text-light p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                    ...
                    Proveedores</a>
                <a href="{{ route('clientes-index') }}" class="d-block text-light p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
